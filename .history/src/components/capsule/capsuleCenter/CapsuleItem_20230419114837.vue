<template>
  ...
  >
    ...
    <!-- 胶囊样式图片 -->
    <img v-if="x.lockOrNot" class="capsule-img" :src="openCapsuleSrc" /> 
    <img v-else class="capsule-img" src="@/assets/记忆胶囊蓝.png" />
    <!-- 胶囊状态样式图片 -->
    <img v-if="x.lockOrNot" class="capsule-status-img" :src="lockImgSrc" />
    <img v-else class="capsule-img" src="@/assets/沙漏.png" />
