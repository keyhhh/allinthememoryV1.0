<template>
  <div
    ...
    :key="capsule.id"
    @click="toCapsuleDetail($event, value, capsule.capsuleId)"
  >
...
export default {
  ...
  setup() {
    ...
    const toCapsuleDetail = (event, value,capsuleId) => {
      router.push({
        // name: "capsuleDetail",
        // query: {
      ...
      console.log("eventevent",event, "valuevaluevalue",value,"capsuleIdcapsuleIdcapsuleId",capsuleId);
    };
