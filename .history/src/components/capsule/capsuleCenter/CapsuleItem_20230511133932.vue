<template>
  ...
  >
    ...
    <div>
          ...
          <div style="display: inline-flex; align-items: center;font-size:30px ;">
            <el-icon style="margin-right: 4px" :size="30">
              <Calendar />
            </el-icon>
            {{ capsule.title }}
          </div>

      <div class="countdown-footer" style="margin-top: 1%;">{{ capsule.dateSend.slice(0, 10) }}</div>
    </div>
