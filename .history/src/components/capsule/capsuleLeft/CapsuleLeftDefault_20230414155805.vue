<template>
  <div class="capsule-left-default">
    ...
    <p ref=""style="vertical-align:middle ;"><img   :src="src" class="addCapsuleImg" @click="dialogFormVisible = true" /></p>
    ...
    >
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <!-- 保存添加记忆胶囊 -->
          <el-button type="primary" @click="commitCapsule"> 
            封存
          </el-button>
        </span>
      </template>
