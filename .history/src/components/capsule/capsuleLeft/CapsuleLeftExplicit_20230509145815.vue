<template>
  <!-- 胶囊tittle -->
  <h3>标题:&ensp;{{ capsuleShow.title }}</h3>
  <!-- 胶囊建立时间 -->
  <h3>建立时间:{{ capsuleShow.capsuleTittle }}</h3>
  <!-- 胶囊发送时间 -->
  <h3>发送时间:{{ capsuleShow.capsuleTittle }}</h3>
  <!-- 胶囊剩余解锁时间 -->
  <h3>剩余时间:{{ capsuleShow.capsuleTittle }}小时</h3>
  <!-- 胶囊发送渠道 -->
  <h3>发送渠道:{{ capsuleShow.typeSend }}</h3>
</template>
