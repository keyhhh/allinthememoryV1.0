    ...
    >
      <el-form :model="recordForm">
        ...
        <el-form-item label="Tag" :label-width="formLabelWidth">
          <el-cascader :options="options" clearable :show-all-levels="false" />
        </el-form-item>
...
import { defineComponent, ref, nextTick, reactive import { getCurrentInstance } from "vue";} from "vue";
  ...
  setup() {
    ...
    const commitRecord = () => {
      ...
      if (recordForm.title == "") {
        ...
        //提交
        console.log("走了else");
        proxy.$refs.pictureUpload.submit();
