  ...
  setup() {
    ...
    const commitRecord = () => {
      ...
      if (record.message == "") {
        ...
        let record = {
          datePublish: this.record.datePublish,
          userId: this.record.datePublish,
          message: this.record.datePublish,
          tag: this.record.datePublish,
          image: this.record.datePublish,
          isPublic: this.record.datePublish,
          isMemory: this.record.datePublish,
        };
