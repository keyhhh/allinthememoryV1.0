    ...
    >
      <el-form :model="recordForm">
        ...
        <el-form-item label="Tag" :label-width="formLabelWidth">
          <el-cascader :options="options" clearable :show-all-levels="false" v-model="recordForm.tag"/>
        </el-form-item>
        ...
        <el-form-item label="Picture" :label-width="formLabelWidth">
          ...
          >
            ...
            <template #file="{ file }" v-model="recordForm.file">
              <div>
                <img
  ...
  setup() {
    ...
    const commitRecord = () => {
      ...
      if (recordForm.title == "") {
        ...
        //提交
        console.log("走了else",pictureUpload.value,"recordForm",recordForm);
