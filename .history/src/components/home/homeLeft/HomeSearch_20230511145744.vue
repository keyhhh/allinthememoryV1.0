<template>
  <div class="home-search">
    ...
    <!-- 日期选择框 
          style="width: 80%"设置长度
        -->
    <el-divider style="width: 80%" content-position="left"> 全部记录
    </el-divider>

    <el-button type="success" round>Success</el-button>

    <el-divider style="width: 80%;" content-position="right"> <span style="font-size: 10px;">搜索记录</span>
    </el-divider>
...
export default defineComponent({
  ...
  setup() {
    ...
    function clickTag(event, tag) {
      //点击标签的方法
      searchTagValue.value = tag;
      console.log("dianle", event, tag);
      //根据标签搜索记录信息
    }
...
/* 分割线上文字的背景色 */
::v-deep .el-divider__text.is-right,.el-divider__text.is-right{
