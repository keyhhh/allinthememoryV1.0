    ...
    >
      <el-form :model="record">
        ...
        <el-form-item label="IsMemory" :label-width="formLabelWidth">
          <el-radio-group v-model="record.isMemory" class="ml-4">
            <el-radio :label="true" size="large">集体记忆</el-radio>
            <el-radio :label="false" size="large">我的记录</el-radio>
          </el-radio-group>
          <el-radio-group
            v-model.number="record.isMemory"
            size="small"
          >
            <el-radio :label="1" border>我的记录</el-radio>
            <el-radio :label="0" border>集体记忆</el-radio>
          </el-radio-group>
        </el-form-item>
  ...
  setup() {
    ...
    const commitRecord = () => {
      ...
      if (record.message == "") {
        ...
        pictureUpload.value.submit(); //主动提交图片
