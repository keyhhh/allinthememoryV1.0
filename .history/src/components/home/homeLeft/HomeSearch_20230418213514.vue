    ...
    >
      <el-form :model="recordForm">
        ...
        <el-form-item label="RecordOpen" :label-width="formLabelWidth">
          <el-radio-group v-model="recordForm.recordOpenOrNot" class="ml-4">
            <el-radio :label="true" size="large">公开记录</el-radio>
            <el-radio :label="false" size="large">私密记录</el-radio>
          </el-radio-group>
        </el-form-item>
        <!-- 记忆内容输入框 -->
      ...
      <el-upload ref="pictureUpload"  action="#" list-type="picture-card" :auto-upload="false">
...
————————————————
版权声明：本文为CSDN博主「前端不加班」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/m0_49515138/article/details/128613048
    };
