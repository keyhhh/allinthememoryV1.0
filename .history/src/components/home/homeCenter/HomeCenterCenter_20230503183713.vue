<template>
  <el-timeline>
    ...
    >
      <el-card>
        <img :src="record.image" style="width: 45%; margin-right: 5%" />
        ...
        <!-- <el-switch
          ...
          inactive-text="私密"
        /> -->
        <el-radio-group v-model.number="record.isPublic" class="ml-4">
          <el-radio label.number="1" size="large">公开</el-radio>
          <el-radio label.number="0" size="large">私密</el-radio>
        </el-radio-group>
      </el-card>
    </el-timeline-item>
