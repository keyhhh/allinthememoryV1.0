<template>
  <el-card class="box-card" v-for="card in publicRecord" :key="card.id">
    ...
    <div class="text item">
      ...
      <img src="./communist_party.jpg" style="style=width: 80px; height: 100px; margin: 0 5% 0 5%">
      <img src="./communist_party.jpg" style="style=width: 80px; height: 100px">
      <img src="./communist_party.jpg" style="style=width: 80px; height: 100px">
      <video controls src="@/components/home/homeCenter/《你从未离去》.mp4"  style="style=width: 80px; height: 100px"></video>
      <br />
      <p>{{ card.msg }}</p>
    </div>
  </el-card>
