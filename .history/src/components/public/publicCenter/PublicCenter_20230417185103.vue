<template>
  <el-card class="box-card" v-for="card in publicRecord" :key="card.id">
    ...
    <div class="text item">
      ...
      <img src="./communist_party.jpg" style="style=width: 80px; height: 100px"><img src="./communist_party.jpg" style="style=width: 80px; height: 100px"><img src="./communist_party.jpg" style="style=width: 80px; height: 100px">
      <br />
      <p>{{ card.msg }}</p>
    </div>
  </el-card>
