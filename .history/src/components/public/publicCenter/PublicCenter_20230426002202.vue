  ...
  <el-card class="box-card" v-for="card in publicRecord" :key="card.id">
    <template #header>
      <div class="card-header">
        ...
        <p style="text-align: center;vertical-align:middle;line-height: 200px;">喜<img :src="liskeImgSrcR" style="width:12%" />欢</p> 
      </div>
    </template>
    <div class="text item">
      <!-- <el-image
      ...
      <video
        controls
        src="@/components/home/homeCenter/《你从未离去》.mp4"
        style="style=width: 80px; height: 100px; margin: 0 1% 0 1%"
      ></video>
      <br />
      <p>{{ card.msg }}</p>
...
export default {
  setup() {
    ...
    return { publicRecord, liskeImgSrcR, liskeImgSrcG };
  },
};
</script>
