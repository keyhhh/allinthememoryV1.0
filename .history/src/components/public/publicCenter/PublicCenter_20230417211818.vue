<template>
  <el-card class="box-card" v-for="card in publicRecord" :key="card.id">
    <template #header>
      <div class="card-header">
        ...
        <el-button class="button" text>data</el-button>
      </div>
    </template>
    <div class="text item">
      ...
      <!-- <video style="width:80%"  :src="null" controls />   后期使用v-show判断是否展示 -->
      <img src="./communist_party.jpg" style="style=width: 23%px; height: 100px; margin: 0 1% 0 1%">
      <img src="./communist_party.jpg" style="style=width: 80px; height: 100px; margin: 0 1% 0 1%">
      <img src="./communist_party.jpg" style="style=width: 80px; height: 100px; margin: 0 1% 0 1%">
      <video controls src="@/components/home/homeCenter/《你从未离去》.mp4"  style="style=width: 80px; height: 100px; margin: 0 1% 0 1%"></video>
      <br />
      <p>{{ card.msg }}</p>
    </div>
  </el-card>
