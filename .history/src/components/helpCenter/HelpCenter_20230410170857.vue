<template>
  ...
  <el-row type="flex" justify="center">
    <el-col
      ...
      v-for="(o, index) in helpAllTestData.length"
      :key="o"
      :span="8"
...
export default {
  setup() {
    const helpAllTestData = [ //求助信息
      { id: 11,title:"", name: "第一条" },
      { id: 22, title:"", name: "第二条" },
      { id: 33,title:"",  name: "第三条" },
      { id: 44, title:"", name: "第4条" },
      { id: 55,title:"",  name: "第5条" },
    ];
    ...
    return { helpAllTestData, currentDate, toShowHelpDetail };
  },
};
</script>
