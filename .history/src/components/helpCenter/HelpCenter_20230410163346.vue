<template>
  ...
  <el-row type="flex" justify="center">
    <el-col
      ...
      v-for="(o, index) in cardNumbers"
      :key="o"
      :span="8"
      :offset="index % 2 > 0 ? 2 : 0"
    >
      <el-card shadow="always" :body-style="{ padding: '0px' }"  @click.stop="toShowHelpDetail">
        <img
...
export default {
  setup() {
    ...
    const cardNumbers = ref(20); //求助信息的卡片数量
    ...
    return { currentDate, cardNumbers,toShowHelpDetail };
  },
  unmounted(){
    const route = useRoute();
    console.log("/help下的route中参数",route.params)
  }
};
</script>
