<template>
  ...
  <el-row type="flex" justify="center">
    ...
    >
      ...
      >
        <div v-if="help.image != ''">
          <div v-if="help.image.length > 1">
            <img
              v-for="index in 1"
              :key="index"
              :src="require('../../../assets/ALMIMG/' + help.image[index])"
          ...
          <div v-else>
            <img
              ...
              :key="index"
              :src="require('../../../assets/ALMIMG/' + help.image[id-1])"
              style="width: 45%; margin-right: 5%"
            />
          </div>
        </div>
        <div style="padding: 14px">
          ...
          <div class="bottom">
            <time
              class="help-little-msg"
              style="width: 70%; line-height: 20px; text-indent: 2em"
