<template>
  <div class="help-detail-div">
    ...
    <div class="help-detail-center">
      ...
      <el-switch v-model="helpShow[0].isLikedHelp" />
    </div>
    ...
    getHelpByID(help).then((res) => {
      if (res.data.code) {
        helpShow.push({
          ...
          likedHelpId:
            res.data.data.likedHelpId == null
              ? []
              : res.data.data.likedHelpId.split(","),
          isLikedHelp: res.data.data.likedHelpId == null
          ? false
          : res.data.data.likedHelpId
          .split(",")
          .
        });
      } else {
