    ...
    >
      ...
      >
        ...
        <div style="padding: 14px">
          ...
          <div class="bottom">
            <time class="help-little-msg" style="width:60%">{{ help.message.slice(0, 60) }}......</time>
            <span text class="data-section">{{ help.datePublish.slice(0, 10) }}</span><br/>
                    <!-- 删除按钮 -->
        <el-button style="margin-left:15% ;" type="danger" @click="deleteRecord(index, $event)"
          >删除</el-button
        >
          </div>
        </div>
