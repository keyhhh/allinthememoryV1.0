  ...
  setup() {
          ...
          if (res.data.code) {
            getDiscuss(help).then((res) => {
              ...
              if (res.data.code) {
                ...
                // }
                helpDiscussShow.push({
                  message: res.data.data[res.data.data.length - 1].message.slice(0, 10), 
                  datePublish: res.data.data[res.data.data.length - 1].datePublish,
                });
              } else {
    ...
    getDiscuss(help).then((res) => {
      ...
      if (res.data.code) {
        for (let index = 0; index < res.data.data.length; index++) {
          helpDiscussShow.push({
            message: res.data.data[index].message.slice(0, 10), 
            datePublish: res.data.data[index].datePublish,
          });
        }
      } else {
