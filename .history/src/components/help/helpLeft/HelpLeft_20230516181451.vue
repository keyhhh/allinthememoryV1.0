<template>
  <div class="help-left-default">
    <h4 style="text-align: center">发布求助</h4>
    ...
    >
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <!-- 保存添加求助信息 -->
          <el-button type="primary" @click="commitHelp"> 发布 </el-button>
        </span>
      </template>
    </el-dialog>

    <div style="text-align: center; margin-top: 20%">
      <el-button type="primary" @click="toMyLike">我的同求</el-button>
      <el-button type="primary" @click="toMyPu">我的发布</el-button><hr/>
      <el-button type="success" @click="toMyAll">全部信息</el-button>
    </div>
  </div>
</template>
