      ...
      <el-card class="box-card">
        ...
        >
          ...
          <el-descriptions-item>
            ...
            {{userInfo[0].birthday.substring(0,4)}} 年
            {{userInfo[0].birthday.substring(5,7)}} 月
            {{userInfo[0].birthday.substring(8,10)}} 日
          </el-descriptions-item>
          <el-descriptions-item>
            <template #label>
              <div class="cell-item">紧急联系人</div>
            </template>
            <el-tag size="small">{{userInfo[0].urgentContact}}</el-tag>
          </el-descriptions-item>
        </el-descriptions>
      </el-card>
    </el-col>
