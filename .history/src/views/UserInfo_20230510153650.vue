  ...
  <el-dialog class="el-dialog" v-model="dialogFormVisible" title="个人 信息">
    <el-form :model="record">
      ...
      <el-form-item label="用户名" :label-width="formLabelWidth">
        <el-input
          v-model="userInfoShow[0].userName"
          autocomplete="off"
          placeholder="用户名"
        />
      </el-form-item>
      ...
      <el-form-item label="性别" :label-width="formLabelWidth">
        <el-radio-group v-model="userInfoShow[0].gender" class="ml-4">
      ...
      <el-form-item label="账号" :label-width="formLabelWidth">
        <el-input
          disabled
          v-model="userInfoShow[0].account"
          autocomplete="off"
          placeholder="账号"
        />
      </el-form-item>
      ...
      <el-form-item label="生日" :label-width="formLabelWidth">
        <el-date-picker
          ...
          id="el-date-picker"
          v-model="userInfoShow[0].birthday"
          type="date"
      ...
      <el-form-item label="紧急联系人电话" :label-width="formLabelWidth">
        <el-input
          v-model="userInfoShow[0].urgentContact"
          autocomplete="off"
          placeholder="紧急联系人电话"
        />
      </el-form-item>
      ...
      <el-form-item label="头像" :label-width="formLabelWidth">
        ...
        >
          ...
          <el-icon v-else style="width: 100%">
            <el-avatar
              :size="size"
              :src="require('../assets/ALMIMG/' + userInfoShow[0].avatar)"
            />
          </el-icon>
        </el-upload>
      </el-form-item>
...
export default {
  ...
  setup() {
    ...
    let userInfoShow = reactive([]);//用来修改哦的
    userInfoShow.push({
      userName:userInfo[0].userName,
      account:userInfo[0].userName,
      phone:userInfo[0].userName,
      urgentContact:userInfo[0].userName,
      gender:userInfo[0].userName,
      birthday:userInfo[0].userName,
      avatar:userInfo[0].userName,
    })

    const onUploadSuccess = (response) => {
      //上传文件成功是的回调
      console.log("wq#$%^&", response.data);
      userInfo[0].avatar=(response.data); //上传成功后返回的存储在本地的图片名，push到data中去
    };

    return { dialogFormVisible, formLabelWidth, userInfo, userInfoShow, onUploadSuccess };
  },
};
</script>
